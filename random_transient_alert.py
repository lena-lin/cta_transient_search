...
def main(
    ...
    percentage_transient_noise = timeseries_table.meta['percentage_transient_noise']
    ...
    alert_table.write('{}/n{}_s{}_p{}_alert.hdf5'.format(output_path, n_transient, num_slices,percentage_transient_noise), path='data', overwrite=True)
