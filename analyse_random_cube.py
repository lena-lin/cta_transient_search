...
def main(
    ...
    percentage_transient_noise = cube_raw_table.meta['percentage_transient_noise']
    ...
    denoised_table.write('{}/n{}_s{}_p{}_denoised.hdf5'.format(output_path, n_transient, num_slices,percentage_transient_noise), path='data', overwrite=True)
