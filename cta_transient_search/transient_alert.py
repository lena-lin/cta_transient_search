...
def main(
    ...
    if background == True:
        ...
        alert_table.write('{}/n{}_s{}_t{}_bg_bgSubs_3dwavelet_maxPixel_alert.hdf5'.format(
                                                                output_path,
                                                                n_cubes,
                                                                num_slices,
                                                                time_per_slice,
        ...
        alert_table.write('{}/n{}_s{}_t{}_i{}_cu{}_z{}_bgSubs_3dwavelet_maxPixel_alert.hdf5'.format(
                                                                        output_path,
                                                                        n_transient,
                                                                        num_slices,
                                                                        time_per_slice,
