...
irf_path= '/home/jana/Schreibtisch/Projekt Master' ## Jana 
n_transient=10
...
build/n$(n_transient)_s$(num_slices)_t$(transient_template_filename)_alert.hdf5 : transient_alert.py build/n$(n_transient)_s$(num_slices)_t$(transient_template_filename)_trigger.hdf5 | build
	python transient_alert.py build/n$(n_transient)_s$(num_slices)_t$(transient_template_filename)_trigger.hdf5
